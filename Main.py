...
class gui:
    def __init__(self):
        ...
        self.var2 = tk.IntVar()
        self.times = tk.Entry(self.window, textvariable=self.var2, validate="key", validatecommand=(vcmd, '%P'))
        ...
        self.button3 = tk.Button(self.window, text='GO!!', command=self.button_event_3, font=('Arial', 12))
        self.button3.grid(row=7, column=0,pady=35)
        self.button4 = tk.Button(self.window, text='Quit', command=self.button_event_4, font=('Arial', 12))
        self.button4.grid(row=7, column=1,pady=35)
